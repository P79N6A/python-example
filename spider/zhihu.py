...
def getdata(username, password, captcha=''):
    ...
    """)
    signature = js1.call(u'run', u'password', timestamp)
    data = {
...
def login(username, password):
    ...
    encoder = MultipartEncoder(data, boundary='-----WebKitFormBoundarybqwwkQAjMSAGW9gJ')
...
#session_token=8a4ce4dc52ffa49101cfa3f806b449fe
def getCtx():
    '登陆后，从网页源代码内解析出session_token，'
    z1 = s.get('http://www.zhihu.com')
    p1 = re.search(r'session_token=(.*?)&amp;',z1.content)
    session_token= p1.group(1)
    print 'session_token:'+session_token;
    url='https://www.zhihu.com/api/v3/feed/topstory?action_feed=True&limit=8&session_token='+session_token+'&action=down&after_id=7&desktop=true'
    c=s.get(url);
    print c.content;
    print json.loads(c.content)['error']['message']


if __name__ == '__main__':
    username = '18457177669'
    password = 'zhoupj1987'
